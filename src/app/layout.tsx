...
export const metadata: Metadata = {
  ...
  description: 'We do not sell routers. We design confidence. Premium wireless environments for luxury homes, boutique hospitality, and executive spaces.',
  keywords: 'premium wifi, luxury connectivity, Wi-Fi 7, seamless wireless, private connectivity design',
  openGraph: {
    title: 'AUREL — Invisible Premium Connectivity',
